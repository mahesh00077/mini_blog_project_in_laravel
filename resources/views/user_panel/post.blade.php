...
<?php
$posted_date = date('d F Y', strtotime($sinlge_post_data[0]->created_at));
// die;
?>
@section('bg-img',asset('images/'.$sinlge_post_data[0]->image_path))
@section('title',$sinlge_post_data[0]->title)
@section('sub-heading',$sinlge_post_data[0]->subtitle)
@section('posted-by',$sinlge_post_data[0]->role_name)
@section('posted-date',$posted_date)
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                {{strip_tags($sinlge_post_data[0]->body)}}
